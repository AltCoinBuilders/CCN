...
const string strMessageMagic = "CCN Signed Message:\n";
...
{
    int64_t nSubsidy = nCoinAge * 33 / (365 * 33 + 8) * (20 * CENT); // 20% Forever
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "CCN", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "CryptoCrowdNetwork created by AltCoinBuilders.";
        CTransaction txNew;
        txNew.nTime = 1576525635;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1576525635;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce   = !fTestNet ? 1209347 : 1209347;
        ...
        assert(block.hashMerkleRoot == uint256("0xacf1a9129f1d664b653a19f6e7fea22f10c65afba32e41d19bac7eab92056cfc"));
...
unsigned char pchMessageStart[4] = { 0x9e, 0xd8, 0x16, 0xe2 };
